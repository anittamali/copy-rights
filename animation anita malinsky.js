...
lib.ssMetadata = [
		{name:"animation anita malinsky_atlas_1", frames: [[0,0,1659,1575]]},
		{name:"animation anita malinsky_atlas_2", frames: [[0,0,1584,1497]]},
		{name:"animation anita malinsky_atlas_3", frames: [[0,0,1328,1222],[1330,0,678,1622]]},
		{name:"animation anita malinsky_atlas_4", frames: [[1236,1418,154,104],[1725,1420,154,88],[1881,1420,154,78],[482,1421,154,68],[973,1421,142,70],[482,1491,140,63],[973,1493,136,57],[0,0,284,419],[1804,0,242,476],[1804,478,242,476],[244,940,242,472],[1308,0,246,479],[1556,0,246,479],[0,421,246,479],[248,459,246,479],[496,477,245,472],[1056,0,250,472],[547,0,249,475],[0,902,242,473],[993,948,241,471],[732,1392,239,468],[244,1414,236,469],[488,951,242,468],[1798,956,243,462],[1236,955,245,461],[743,928,248,462],[798,463,252,463],[1548,942,248,459],[1483,1403,240,462],[0,1377,242,463],[1548,481,251,459],[798,0,256,461],[286,0,259,457],[1301,481,245,472],[1052,474,247,472],[496,459,38,16],[743,534,38,16],[743,477,38,17],[743,624,38,14],[743,684,38,9],[743,656,38,12],[743,552,38,16],[743,570,38,16],[743,496,38,17],[743,640,38,14],[743,695,38,9],[743,670,38,12],[743,588,38,16],[743,606,38,16],[743,515,38,17]]},
		{name:"animation anita malinsky_atlas_5", frames: [[630,1058,305,422],[1424,1303,264,454],[648,0,277,519],[1266,437,310,429],[326,1051,302,431],[0,1385,324,418],[1573,868,311,420],[1578,431,315,422],[322,625,318,424],[1260,876,311,425],[955,876,303,437],[0,955,320,428],[862,1482,291,427],[1576,0,320,429],[927,0,322,439],[1251,0,323,435],[642,625,311,431],[1155,1315,267,464],[326,1484,268,465],[596,1484,264,472],[1690,1290,264,454],[955,441,309,433],[263,0,383,623],[0,0,261,953]]},
		{name:"animation anita malinsky_atlas_6", frames: [[1215,0,308,1618],[0,1129,1213,659],[0,0,807,1127],[1525,0,261,977],[1788,0,260,961],[1787,979,261,959],[809,0,261,979],[1525,979,260,963]]}
];
...
(lib.CachedBmp_83 = function() {
	this.initialize(ss["animation anita malinsky_atlas_5"]);
	this.gotoAndStop(0);
...
(lib.CachedBmp_89 = function() {
	this.initialize(ss["animation anita malinsky_atlas_4"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
(lib.CachedBmp_26 = function() {
	this.initialize(ss["animation anita malinsky_atlas_1"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
(lib.CachedBmp_23 = function() {
	this.initialize(ss["animation anita malinsky_atlas_6"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
(lib.CachedBmp_3 = function() {
	this.initialize(ss["animation anita malinsky_atlas_3"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
(lib.CachedBmp_2 = function() {
	this.initialize(ss["animation anita malinsky_atlas_2"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
}).prototype = getMCSymbolPrototype(lib.Symbol1, new cjs.Rectangle(0,0,77,52), null);
...
}).prototype = getMCSymbolPrototype(lib.button, new cjs.Rectangle(0,0,1661.1,857.7), null);
...
(lib.sofa = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance_11.setTransform(459.1,-366.75,0.5,0.5);

	this.instance_12 = new lib.CachedBmp_16();
	this.instance_12.setTransform(459.1,-368.1,0.5,0.5);
	...
	this.instance_14.setTransform(459.1,-367.15,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance}]}).to({state:[{t:this.instance_1}]},3).to({state:[{t:this.instance_2}]},8).to({state:[{t:this.instance_3}]},3).to({state:[{t:this.instance_4}]},3).to({state:[{t:this.instance_5}]},3).to({state:[{t:this.instance_6}]},2).to({state:[{t:this.instance_7}]},3).to({state:[{t:this.instance_8}]},4).to({state:[{t:this.instance_9}]},4).to({state:[{t:this.instance_10}]},4).to({state:[{t:this.instance_11}]},4).to({state:[{t:this.instance_12}]},3).to({state:[{t:this.instance_13}]},4).to({state:[{t:this.instance_14}]},4).wait(4));

	// BG
	this.instance_15 = new lib.CachedBmp_95();
	this.instance_15.setTransform(-706.95,-477.75,0.5,0.5);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.text},{t:this.instance_15}]}).wait(56));
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-34,-14.3,0.5,0.5);

	this.instance_1 = new lib.CachedBmp_76();
	this.instance_1.setTransform(-35.05,-15.8,0.5,0.5);

	this.instance_2 = new lib.CachedBmp_77();
	this.instance_2.setTransform(-35.55,-17.3,0.5,0.5);

	this.instance_3 = new lib.CachedBmp_78();
	this.instance_3.setTransform(-38.25,-16.75,0.5,0.5);

	this.instance_4 = new lib.CachedBmp_79();
	this.instance_4.setTransform(-38.3,-19.25,0.5,0.5);

	this.instance_5 = new lib.CachedBmp_80();
	this.instance_5.setTransform(-38.35,-21.75,0.5,0.5);

	this.instance_6 = new lib.Symbol1();
	this.instance_6.setTransform(0.25,0.4,1,1,0,0,0,38.6,26.1);
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance}]}).to({state:[{t:this.instance_1}]},57).to({state:[{t:this.instance_2}]},9).to({state:[{t:this.instance_3}]},11).to({state:[{t:this.instance_4}]},11).to({state:[{t:this.instance_5}]},11).to({state:[{t:this.instance_6}]},12).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[]},1).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(111).to({_off:false},0).wait(1).to({regX:38.5,regY:26,x:0.15,y:0.3},0).wait(9).to({_off:true},1).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-38.3,-25.7,77.1,52);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-393.45,-275.2,0.5,0.5);
...
}).prototype = getMCSymbolPrototype(lib.replay, new cjs.Rectangle(-393.4,-275.2,774.7,563.5), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_16.setTransform(794.2,450.85,1,1,0,0,0,-0.2,17.8);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_16).wait(463).to({_off:false},0).wait(1).to({regX:-19.3,regY:69,x:775.05,y:500.95},0).wait(1).to({x:775,y:499.9},0).wait(1).to({x:774.95,y:498.85},0).wait(1).to({x:774.9,y:497.8},0).wait(1).to({y:496.75},0).wait(1).to({x:774.85,y:495.7},0).wait(1).to({x:774.8,y:494.65},0).wait(1).to({x:774.75,y:493.6},0).wait(1).to({y:492.55},0).wait(1).to({x:774.7,y:491.5},0).wait(1).to({x:774.65,y:490.45},0).wait(1).to({x:774.6,y:489.4},0).wait(1).to({x:774.55,y:488.35},0).wait(1).to({y:487.3},0).wait(1).to({x:774.5,y:486.25},0).wait(1).to({x:774.45,y:485.2},0).wait(1).to({x:774.4,y:484.15},0).wait(1).to({y:483.1},0).wait(1).to({x:774.35,y:482.05},0).wait(1).to({x:774.3,y:481},0).wait(1).to({x:774.25,y:479.95},0).wait(1).to({x:774.2,y:478.9},0).wait(1).to({y:477.85},0).wait(1).to({x:774.15,y:476.8},0).wait(1).to({x:774.1,y:475.7},0).wait(1).to({x:774.05,y:474.65},0).wait(1).to({y:473.6},0).wait(1).to({x:774,y:472.55},0).wait(1).to({x:773.95,y:471.5},0).wait(1).to({x:773.9,y:470.45},0).wait(1).to({x:773.85,y:469.4},0).wait(1).to({y:468.35},0).wait(1).to({x:773.8,y:467.3},0).wait(1).to({x:773.75,y:466.25},0).wait(1).to({x:773.7,y:465.2},0).wait(1).to({y:464.15},0).wait(1).to({x:773.65,y:463.1},0).wait(1).to({x:773.6,y:462.05},0).wait(1).to({x:773.55,y:461},0).wait(1).to({x:773.5,y:459.95},0).wait(1).to({y:458.9},0).wait(1).to({x:773.45,y:457.85},0).wait(1).to({x:773.4,y:456.8},0).wait(1).to({x:773.35,y:455.75},0).wait(1).to({y:454.7},0).wait(1).to({x:773.3,y:453.65},0).wait(1).to({x:773.25,y:452.6},0).wait(1).to({x:773.2,y:451.55},0).wait(1).to({x:773.15,y:450.5},0).wait(1));
...
if (reversed == null) { reversed = false; }
	...
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("rgba(102,102,102,0)").ss(1,1,1).p("Eg84gisMB42AAAIA7AAMAAABFZIg7AAMh42AAA");
	this.shape_1.setTransform(683.425,433.175);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#121026").s().p("Eg79AitIg6AAMAAAhFZIA6AAMB42AAAMAAABFZg");
	this.shape_2.setTransform(677.55,433.175);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f().s("rgba(102,102,102,0)").ss(1,1,1).p("AhxAhIg+hBIFfAA");
	this.shape_3.setTransform(644.75,319.525);

	this.instance_5 = new lib.smile("synched",0);
	this.instance_5.setTransform(430.45,238.45,0.5618,0.5321,0,-2.6854,0.3299);

	this.instance_6 = new lib.sofa("synched",0);
	this.instance_6.setTransform(554.95,487.9,1,1,0,0,0,0,-1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape},{t:this.instance}]}).to({state:[{t:this.instance_1}]},120).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_2}]},1).to({state:[{t:this.instance_3}]},68).to({state:[{t:this.text}]},197).to({state:[{t:this.text}]},3).to({state:[{t:this.text}]},3).to({state:[{t:this.text}]},3).to({state:[{t:this.text}]},3).to({state:[{t:this.text}]},3).to({state:[{t:this.text}]},3).to({state:[{t:this.text}]},3).to({state:[{t:this.text}]},3).to({state:[{t:this.text}]},3).to({state:[{t:this.text}]},3).to({state:[{t:this.text}]},3).to({state:[{t:this.text}]},3).to({state:[{t:this.text}]},3).to({state:[{t:this.text}]},3).to({state:[{t:this.text}]},3).to({state:[{t:this.text}]},3).to({state:[{t:this.shape_2},{t:this.shape_1},{t:this.instance_4}]},11).to({state:[{t:this.shape_3},{t:this.instance_4},{t:this.text}]},51).to({state:[{t:this.instance_6},{t:this.instance_5}]},7).wait(122));
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(120).to({_off:false},0).wait(1).to({x:2054.15,y:318.75},0).wait(1).to({x:2035.55,y:318.85},0).wait(1).to({x:2017,y:318.95},0).wait(1).to({x:1998.4,y:319.05},0).wait(1).to({x:1979.8,y:319.15},0).wait(1).to({x:1961.2,y:319.25},0).wait(1).to({x:1942.6,y:319.3},0).wait(1).to({x:1924,y:319.4},0).wait(1).to({x:1905.4,y:319.5},0).wait(1).to({x:1886.8,y:319.6},0).wait(1).to({x:1868.2,y:319.7},0).wait(1).to({x:1849.55,y:319.8},0).wait(1).to({x:1830.95,y:319.9},0).wait(1).to({x:1812.35,y:319.95},0).wait(1).to({x:1793.75,y:320.05},0).wait(1).to({x:1775.15,y:320.15},0).wait(1).to({x:1756.55,y:320.25},0).wait(1).to({x:1737.95,y:320.35},0).wait(1).to({x:1719.35,y:320.45},0).wait(1).to({x:1700.75,y:320.55},0).wait(1).to({x:1682.15,y:320.6},0).wait(1).to({x:1663.55,y:320.7},0).wait(1).to({x:1644.95,y:320.8},0).wait(1).to({x:1626.3,y:320.9},0).wait(1).to({x:1607.7,y:321},0).wait(1).to({x:1589.1,y:321.1},0).wait(1).to({x:1570.5,y:321.15},0).wait(1).to({x:1551.9,y:321.25},0).wait(1).to({x:1533.3,y:321.35},0).wait(1).to({x:1514.7,y:321.45},0).wait(1).to({x:1496.1,y:321.55},0).wait(1).to({x:1477.5,y:321.65},0).wait(1).to({x:1458.9,y:321.75},0).wait(1).to({x:1440.3,y:321.8},0).wait(1).to({x:1421.65,y:321.9},0).wait(1).to({x:1403.05,y:322},0).wait(1).to({x:1384.45,y:322.1},0).wait(1).to({x:1365.85,y:322.2},0).wait(1).to({x:1347.25,y:322.3},0).wait(1).to({x:1328.65,y:322.4},0).wait(1).to({x:1310.05,y:322.45},0).wait(1).to({x:1291.45,y:322.55},0).wait(1).to({x:1272.85,y:322.65},0).wait(1).to({x:1254.25,y:322.75},0).wait(1).to({x:1235.65,y:322.85},0).wait(1).to({x:1217.05,y:322.95},0).wait(1).to({x:1198.4,y:323},0).wait(1).to({x:1179.8,y:323.1},0).wait(1).to({x:1161.2,y:323.2},0).wait(1).to({x:1142.6,y:323.3},0).wait(1).to({x:1124,y:323.4},0).wait(1).to({x:1105.4,y:323.5},0).wait(1).to({x:1086.8,y:323.6},0).wait(1).to({x:1068.2,y:323.65},0).wait(1).to({x:1049.6,y:323.75},0).wait(1).to({x:1031,y:323.85},0).wait(1).to({x:1012.4,y:323.95},0).wait(1).to({x:993.75,y:324.05},0).wait(1).to({x:975.15,y:324.15},0).wait(1).to({x:956.55,y:324.25},0).wait(1).to({x:937.95,y:324.3},0).wait(1).to({x:919.35,y:324.4},0).wait(1).to({x:900.75,y:324.5},0).wait(1).to({x:882.15,y:324.6},0).wait(1).to({x:863.55,y:324.7},0).wait(1).to({x:844.95,y:324.8},0).wait(1).to({x:826.35,y:324.85},0).wait(1).to({x:807.75,y:324.95},0).wait(1).to({x:789.15,y:325.05},0).wait(1).to({x:770.5,y:325.15},0).wait(1).to({x:751.9,y:325.25},0).wait(1).to({x:733.3,y:325.35},0).wait(1).to({x:714.7,y:325.45},0).wait(1).to({x:696.1,y:325.5},0).wait(1).to({x:677.5,y:325.6},0).wait(1).to({x:658.9,y:325.7},0).wait(1).to({x:640.3,y:325.8},0).wait(1).to({x:621.7,y:325.9},0).wait(1).to({x:603.1,y:326},0).wait(1).to({x:584.5,y:326.1},0).wait(1).to({x:565.85,y:326.15},0).wait(1).to({x:547.25,y:326.25},0).wait(1).to({x:528.65,y:326.35},0).wait(1).to({x:510.05,y:326.45},0).wait(1).to({x:491.45,y:326.55},0).wait(1).to({x:472.85,y:326.65},0).wait(1).to({x:454.25,y:326.7},0).wait(1).to({x:435.65,y:326.8},0).wait(1).to({x:417.05,y:326.9},0).wait(1).to({x:398.45,y:327},0).wait(1).to({x:379.85,y:327.1},0).wait(1).to({x:361.25,y:327.2},0).wait(1).to({x:342.6,y:327.3},0).wait(1).to({x:324,y:327.35},0).wait(1).to({x:305.4,y:327.45},0).wait(1).to({x:286.8,y:327.55},0).wait(1).to({x:268.2,y:327.65},0).wait(1).to({x:249.6,y:327.75},0).wait(1).to({x:231,y:327.85},0).wait(1).to({x:212.4,y:327.95},0).wait(1).to({x:193.8,y:328},0).wait(1).to({x:175.2,y:328.1},0).wait(1).to({x:156.6,y:328.2},0).wait(1).to({x:137.95,y:328.3},0).wait(1).to({x:119.35,y:328.4},0).wait(1).to({x:100.75,y:328.5},0).wait(1).to({x:82.15,y:328.55},0).wait(1).to({x:63.55,y:328.65},0).wait(1).to({x:44.95,y:328.75},0).wait(1).to({x:26.35,y:328.85},0).wait(1).to({x:7.75,y:328.95},0).wait(1).to({x:-10.85,y:329.05},0).wait(1).to({x:-29.45,y:329.15},0).wait(1).to({x:-48.05,y:329.2},0).wait(1).to({x:-66.65,y:329.3},0).wait(1).to({x:-85.3,y:329.4},0).wait(1).to({x:-103.9,y:329.5},0).wait(1).to({x:-122.5,y:329.6},0).wait(1).to({x:-141.1,y:329.7},0).wait(1).to({x:-159.7,y:329.8},0).wait(1).to({x:-178.3,y:329.85},0).wait(1).to({x:-196.9,y:329.95},0).wait(1).to({x:-215.5,y:330.05},0).wait(1).to({x:-234.1,y:330.15},0).wait(1).to({x:-252.7,y:330.25},0).wait(1).to({x:-271.3,y:330.35},0).wait(1).to({x:-289.95,y:330.45},0).to({_off:true},1).wait(504));
	this.timeline.addTween(cjs.Tween.get(this.text).wait(513).to({_off:false},0).wait(6).to({text:"30 \nM "},0).wait(3).to({text:"30 \nMi "},0).wait(3).to({text:"30 \nMin "},0).wait(3).to({text:"30 \nMinu "},0).wait(3).to({text:"30 \nMinut "},0).wait(3).to({text:"30 Minute"},0).wait(3).to({text:"30 Minutes"},0).wait(3).to({text:"30 Minutes\nL"},0).wait(3).to({text:"30 Minutes\nLa"},0).wait(3).to({text:"30 Minutes\nLat"},0).wait(3).to({text:"30 Minutes\nLate"},0).wait(3).to({text:"30 Minutes\nLater"},0).wait(3).to({text:"30 Minutes\nLater."},0).wait(3).to({text:"30 Minutes\nLater.."},0).wait(3).to({text:"30 Minutes\nLater..."},0).to({_off:true},11).wait(51).to({_off:false,scaleX:1.5278,scaleY:1.5728,x:629.8,y:425.7,text:"da-vinci\n family",font:"10px 'Snap ITC'",color:"#FFFFFF",lineHeight:14.85,lineWidth:94},0).to({_off:true},7).wait(122));
...
if (reversed == null) { reversed = false; }
	...
	// Drawing
	this.instance = new lib.MonaLisaEntranceLeo("synched",0);
	this.instance.setTransform(664.15,1458,8.1141,5.5872,0,0,0,1.2,1);
	this.instance._off = true;
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(316).to({_off:false},0).wait(1).to({regX:-1.2,regY:0,scaleX:8.037,scaleY:5.5329,rotation:0.0515,x:644.75,y:1440.6},0).wait(1).to({scaleX:7.96,scaleY:5.4785,rotation:0.103,x:644.9,y:1428.8},0).wait(1).to({scaleX:7.883,scaleY:5.4242,rotation:0.1546,x:645.05,y:1416.95},0).wait(1).to({scaleX:7.8059,scaleY:5.3698,rotation:0.2061,x:645.2,y:1405.2},0).wait(1).to({scaleX:7.729,scaleY:5.3155,rotation:0.2576,x:645.35,y:1393.4},0).wait(1).to({scaleX:7.6519,scaleY:5.2611,rotation:0.3091,x:645.4,y:1381.6},0).wait(1).to({scaleX:7.5749,scaleY:5.2068,rotation:0.3606,x:645.55,y:1369.85},0).wait(1).to({scaleX:7.4978,scaleY:5.1524,rotation:0.4122,x:645.7,y:1358.05},0).wait(1).to({scaleX:7.4208,scaleY:5.0981,rotation:0.4637,x:645.85,y:1346.25},0).wait(1).to({scaleX:7.3437,scaleY:5.0437,rotation:0.5152,x:645.95,y:1334.45},0).wait(1).to({scaleX:7.2667,scaleY:4.9893,rotation:0.5667,x:646.1,y:1322.65},0).wait(1).to({scaleX:7.1896,scaleY:4.9349,rotation:0.6182,x:646.2,y:1310.85},0).wait(1).to({scaleX:7.1124,scaleY:4.8805,rotation:0.6698,x:646.35,y:1299.1},0).wait(1).to({scaleX:7.0354,scaleY:4.8262,rotation:0.7213,x:646.5,y:1287.3},0).wait(1).to({scaleX:6.9583,scaleY:4.7717,rotation:0.7728,x:646.6,y:1275.5},0).wait(1).to({scaleX:6.8813,scaleY:4.7175,rotation:0.6822,x:646.75,y:1263.75},0).wait(1).to({scaleX:6.8043,scaleY:4.6631,rotation:0.5915,x:646.9,y:1252},0).wait(1).to({scaleX:6.7272,scaleY:4.6087,rotation:0.5009,x:647,y:1240.3},0).wait(1).to({scaleX:6.6502,scaleY:4.5544,rotation:0.4102,x:647.1,y:1228.5},0).wait(1).to({scaleX:6.5731,scaleY:4.5,rotation:0.3196,x:647.2,y:1216.75},0).wait(1).to({scaleX:6.4961,scaleY:4.4456,rotation:0.2289,x:647.35,y:1205},0).wait(1).to({scaleX:6.4189,scaleY:4.3912,rotation:0.1383,x:647.45,y:1193.3},0).wait(1).to({scaleX:6.3418,scaleY:4.3368,rotation:0.0476,x:647.6,y:1181.5},0).wait(1).to({scaleX:6.2647,scaleY:4.2824,rotation:-0.043,x:647.7,y:1169.75},0).wait(1).to({scaleX:6.1878,scaleY:4.2281,rotation:-0.1337,x:647.8,y:1158},0).wait(1).to({scaleX:6.1108,scaleY:4.1738,rotation:-0.2243,x:647.95,y:1146.25},0).wait(1).to({scaleX:6.0337,scaleY:4.1194,rotation:-0.3149,x:648.05,y:1134.5},0).wait(1).to({scaleX:5.9566,scaleY:4.0651,rotation:-0.4056,x:648.2,y:1122.75},0).wait(1).to({scaleX:5.8796,scaleY:4.0107,rotation:-0.4962,x:648.3,y:1111},0).wait(1).to({scaleX:5.8025,scaleY:3.9563,rotation:-0.5869,x:648.45,y:1099.2},0).wait(1).to({scaleX:5.7255,scaleY:3.902,rotation:-0.6775,x:648.6,y:1087.5},0).wait(1).to({scaleX:5.6484,scaleY:3.8476,rotation:-0.6051,x:648.65,y:1075.65},0).wait(1).to({scaleX:5.5713,scaleY:3.7932,rotation:-0.5327,x:648.8,y:1063.9},0).wait(1).to({scaleX:5.4943,scaleY:3.7389,rotation:-0.4602,x:648.95,y:1052.1},0).wait(1).to({scaleX:5.4172,scaleY:3.6845,rotation:-0.3878,x:649.1,y:1040.3},0).wait(1).to({scaleX:5.3401,scaleY:3.6301,rotation:-0.3154,x:649.25,y:1028.5},0).wait(1).to({scaleX:5.2631,scaleY:3.5758,rotation:-0.2429,x:649.4,y:1016.75},0).wait(1).to({scaleX:5.186,scaleY:3.5214,rotation:-0.1705,x:649.5,y:1004.9},0).wait(1).to({scaleX:5.1089,scaleY:3.4669,rotation:-0.0981,x:649.6,y:993.1},0).wait(1).to({scaleX:5.0318,scaleY:3.4126,rotation:-0.0257,x:649.75,y:981.35},0).wait(1).to({scaleX:4.9548,scaleY:3.3582,rotation:0.0468,x:649.9,y:969.55},0).wait(1).to({scaleX:4.8778,scaleY:3.3039,rotation:0.1192,x:650,y:957.75},0).wait(1).to({scaleX:4.8007,scaleY:3.2495,rotation:0.1916,x:650.15,y:946},0).wait(1).to({scaleX:4.7237,scaleY:3.1952,rotation:0.2641,x:650.3,y:934.15},0).wait(1).to({scaleX:4.6467,scaleY:3.1408,rotation:0.3365,x:650.4,y:922.35},0).wait(1).to({scaleX:4.5696,scaleY:3.0865,rotation:0.4089,x:650.55,y:910.6},0).wait(1).to({scaleX:4.4925,scaleY:3.0321,rotation:0.4813,x:650.65,y:898.8},0).wait(1).to({scaleX:4.4154,scaleY:2.9777,rotation:0.5538,x:650.8,y:887},0).wait(1).to({scaleX:4.3384,scaleY:2.9233,rotation:0.6262,x:650.95,y:875.25},0).wait(1).to({scaleX:4.2613,scaleY:2.869,rotation:0.6986,x:651.1,y:863.45},0).wait(1).to({scaleX:4.1842,scaleY:2.8146,rotation:0.7711,x:651.2,y:851.65},0).wait(1).to({scaleX:4.1072,scaleY:2.7602,rotation:0.7343,x:651.3,y:839.9},0).wait(1).to({scaleX:4.0301,scaleY:2.7059,rotation:0.6976,x:651.45,y:828.15},0).wait(1).to({scaleX:3.9531,scaleY:2.6515,rotation:0.6609,x:651.55,y:816.35},0).wait(1).to({scaleX:3.876,scaleY:2.5971,rotation:0.6242,x:651.7,y:804.6},0).wait(1).to({scaleX:3.799,scaleY:2.5428,rotation:0.5875,x:651.85,y:792.8},0).wait(1).to({scaleX:3.7219,scaleY:2.4884,rotation:0.5508,x:651.95,y:781.05},0).wait(1).to({scaleX:3.6449,scaleY:2.434,rotation:0.514,x:652.1,y:769.25},0).wait(1).to({scaleX:3.5678,scaleY:2.3797,rotation:0.4773,x:652.2,y:757.5},0).wait(1).to({scaleX:3.4907,scaleY:2.3253,rotation:0.4406,x:652.3,y:745.7},0).wait(1).to({scaleX:3.4137,scaleY:2.2709,rotation:0.4039,x:652.45,y:733.95},0).wait(1).to({scaleX:3.3366,scaleY:2.2166,rotation:0.3672,x:652.6,y:722.2},0).wait(1).to({scaleX:3.2595,scaleY:2.1622,rotation:0.3305,x:652.7,y:710.45},0).wait(1).to({scaleX:3.1825,scaleY:2.1078,rotation:0.2937,x:652.85,y:698.7},0).wait(1).to({scaleX:3.1055,scaleY:2.0535,rotation:0.257,x:652.95,y:686.9},0).wait(1).to({scaleX:3.0284,scaleY:1.9991,rotation:0.2203,x:653.1,y:675.15},0).wait(1).to({scaleX:2.9513,scaleY:1.9447,rotation:0.1836,x:653.2,y:663.35},0).wait(1).to({scaleX:2.8743,scaleY:1.8904,rotation:0.1469,x:653.35,y:651.6},0).wait(1).to({scaleX:2.7972,scaleY:1.836,rotation:0.1102,x:653.5,y:639.8},0).wait(1).to({scaleX:2.7201,scaleY:1.7816,rotation:0.0734,x:653.6,y:628.05},0).wait(1).to({scaleX:2.643,scaleY:1.7272,rotation:0.0367,x:653.75,y:616.25},0).wait(1).to({scaleX:2.566,scaleY:1.6729,rotation:0,x:653.85,y:604.5},0).to({_off:true},1).wait(124));
...
// stage content:
(lib.animationanitamalinsky = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.timeline.addTween(cjs.Tween.get(this.Drawing).wait(316).to({regX:-0.1,regY:-0.9,scaleX:1.0001,scaleY:1.0001,x:-0.05},0).wait(1).to({regX:644.9,regY:1452.6,scaleX:1,scaleY:1,x:644.9,y:1453.45},0).wait(72).to({regX:68.5,regY:51.9,scaleX:1.1131,scaleY:1.1131,x:0.05,y:0},0).wait(1).to({regX:82.2,regY:62.1,scaleX:1.1388,scaleY:1.1388,x:0,y:-0.1},0).to({_off:true},123).wait(241));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/CachedBmp_25.png?1618070752798", id:"CachedBmp_25"},
		{src:"images/CachedBmp_95.png?1618070752798", id:"CachedBmp_95"},
		{src:"images/BG.png?1618070752798", id:"BG"},
		{src:"images/flash0ai.png?1618070752798", id:"flash0ai"},
		{src:"images/animation anita malinsky_atlas_1.png?1618070752561", id:"animation anita malinsky_atlas_1"},
		{src:"images/animation anita malinsky_atlas_2.png?1618070752562", id:"animation anita malinsky_atlas_2"},
		{src:"images/animation anita malinsky_atlas_3.png?1618070752562", id:"animation anita malinsky_atlas_3"},
		{src:"images/animation anita malinsky_atlas_4.png?1618070752562", id:"animation anita malinsky_atlas_4"},
		{src:"images/animation anita malinsky_atlas_5.png?1618070752563", id:"animation anita malinsky_atlas_5"},
		{src:"images/animation anita malinsky_atlas_6.png?1618070752563", id:"animation anita malinsky_atlas_6"},
		{src:"sounds/Sound_Badguy.mp3?1618070752798", id:"Sound_Badguy"}
	],
	preloads: []
};
